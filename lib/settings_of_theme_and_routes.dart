...
import 'State_management/Theme_configuration/Themes_provider/theme_provider_helper.dart';
...
class GetContextForInheritedThemeManager extends StatelessWidget {
  const GetContextForInheritedThemeManager({super.key});

  @override
  Widget build(BuildContext context) {
    return const InheritedThemeManager(child: ThemeAndRoutesConfiguration());
  }
}
